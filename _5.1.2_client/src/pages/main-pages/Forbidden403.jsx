...
// https://codepen.io/seanysean/pen/ZMwagQ
// https://codepen.io/benrobyg/details/WgYMWL
// https://codepen.io/leenalavanya/pen/RYqvgK

// https://codepen.io/search/pens?q=forbidden&cursor=ZD0xJm89MCZwPTQ=

export const Forbidden403Component = () => {
  return (
    <>
      <div className=" flex flex-col text-center mt-6">
        <h1 className="text-7xl font-extrabold text-indigo-600">403</h1>
...
export const Forbidden403Component1 = () => {
  return (
    <>
